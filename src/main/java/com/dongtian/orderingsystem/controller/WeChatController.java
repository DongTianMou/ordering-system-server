...
public class WeChatController {
    ...
    public String authorize(@RequestParam("returnUrl") String returnUrl) {
        //1. 配置
        //2. 调用方法
        String url = projectUrlConfig.getWechatMpAuthorize() + "/ordering-system/wechat/userInfo";
    ...
    public String userInfo(@RequestParam("code") String code,
        ...
        try {
            ...
            log.error("【微信网页授权】{}", e);
            throw new ParamException(ResultEnum.WECHAT_MP_ERROR.getCode(), e.getError().getErrorMsg());
        }
